...
LIBCV:=$(call qstrip,$(FREETZ_LIBC_VERSION))
...
DIR_SUFFIX:=_$(LIBC)-$(LIBCV)$(if $(FREETZ_AVM_UCLIBC_NPTL_ENABLED),-nptl)
...
KERNEL_BUILD_DIR_TOOLCHAIN:=$(BUILD_DIR_BASE)/toolchain-$(ARCH)$(ARCH_SUFFIX)_gcc-$(GCCV_KERNEL)$(DIR_SUFFIX)
KERNEL_TOOLCHAIN_DIR:=$(TOPDIR)/staging_dir/toolchain-$(ARCH)$(ARCH_SUFFIX)_gcc-$(GCCV_KERNEL)$(DIR_SUFFIX)
TARGET_BUILD_DIR_TOOLCHAIN:=$(BUILD_DIR_BASE)/toolchain-$(ARCH)$(ARCH_SUFFIX)_gcc-$(GCCV_KERNEL)_$(DIR_SUFFIX)
TARGET_TOOLCHAIN_DIR:=$(TOPDIR)/staging_dir/toolchain-$(ARCH)$(ARCH_SUFFIX)_gcc-$(GCCV_KERNEL)_$(DIR_SUFFIX)
