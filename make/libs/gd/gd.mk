...
$(PKG)_STAGING_BINARY:=$(STAGING_DIR)/usr/lib/libgd.so.$($(PKG)_LIB_VERSION)
...
$(PKG)_CONFIGURE_OPTIONS += --with-jpeg=$(STAGING_DIR)/usr
$(PKG)_CONFIGURE_OPTIONS += --with-png=$(STAGING_DIR)/usr
$(PKG)_CONFIGURE_OPTIONS += --with-freetype=$(STAGING_DIR)/usr
