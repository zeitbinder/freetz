...
$(PKG)_LIBS_STAGING_DIR:=$(CLASSPATH_LIBNAMES_LONG:%=$(STAGING_DIR)$(CLASSPATH_LIBRARY_DIR)/%)
...
$($(PKG)_LIBS_TARGET_DIR): $($(PKG)_DEST_DIR)$(CLASSPATH_LIBRARY_DIR)/%: $(STAGING_DIR)$(CLASSPATH_LIBRARY_DIR)/%
