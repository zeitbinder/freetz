$(call PKG_INIT_BIN, 3071700)
$(PKG)_LIB_VERSION:=0.8.6
$(PKG)_SOURCE:=$(pkg)-autoconf-$($(PKG)_VERSION).tar.gz
$(PKG)_SOURCE_SHA1:=e31958e56b1d7bef9433b1ff2e875c8c290d37f4
$(PKG)_SITE:=http://www.sqlite.org/2013
...
$(PKG)_LIB_STAGING_BINARY:=$(STAGING_DIR)/usr/lib/libsqlite3.so.$($(PKG)_LIB_VERSION)
...
$($(PKG)_LIB_STAGING_BINARY): $($(PKG)_LIB_BINARY)
	...
	$(PKG_FIX_LIBTOOL_LA) \
		...
		$(STAGING_DIR)/usr/lib/libsqlite3.la
...
$(pkg)-clean:
	-$(PKG_MAKE) -C $(SQLITE_DIR) clean
	$(RM) -r $(STAGING_DIR)/usr/lib/libsqlite3* \
		$(STAGING_DIR)/lib/pkgconfig/sqlite3.pc \
		$(STAGING_DIR)/usr/include/sqlite \
		$(STAGING_DIR)/usr/bin/sqlite3*
