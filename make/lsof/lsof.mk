...
$(PKG)_CONFIGURE_ENV += LSOF_TSTBIGF="$(if $(FREETZ_TARGET_LFS),$(CFLAGS_LARGEFILE))"
...
$(PKG)_CONFIGURE_ENV += LINUX_INCL="$(STAGING_DIR)/usr/include"
$(PKG)_CONFIGURE_ENV += LSOF_INCLUDE="$(STAGING_DIR)/usr/include"
